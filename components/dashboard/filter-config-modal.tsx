...
export function FilterConfigModal({ open, onClose, onSave, initialData }: FilterConfigModalProps) {
  ...
  const [columnName, setColumnName] = useState(initialData?.column_name || '');
  const [filterType, setFilterType] = useState<DashboardFilterType>(
    initialData?.filter_type || DashboardFilterType.VALUE
  );
                  ...
                  {filterType === DashboardFilterType.VALUE && (
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {hasDefaultValue && filterPreview?.data?.xAxisData && (
                          <div>
                        ...
                        {filterType === DashboardFilterType.NUMERICAL && (
                          <div className="bg-blue-50 p-4 rounded-lg">
                            ...
                            <p className="text-sm text-blue-800">
                              For numerical filters, you can set custom min/max ranges or let users
                              define their own. The actual data range will be determined dynamically
                                ...
                                <div className="space-y-2">
                                  ...
                                  {filterPreview.data.xAxisData.length > 50 && (
                                    <div className="text-center text-sm text-gray-500 p-2">
                                      ... and {filterPreview.data.xAxisData.length - 50} more values
                                    </div>
                                  )}
                                </div>
                              </ScrollArea>
                          ...
                          <div>
                            ...
                            <div className="bg-gray-50 p-4 rounded">
                              <p className="text-sm text-gray-600">
                                This column is ready for numerical filtering. Users will be able to
                                set min/max ranges or single values to filter the data.
                              </p>
