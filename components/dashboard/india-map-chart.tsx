...
export function IndiaMapChart({ filters, onRegionClick, isChatOpen = false }: IndiaMapChartProps) {
  ...
  const mediumRiskRegions = Object.values(regionData).filter(
  ...
  const renderRiskBadge = (riskLevel: string) => {
    ...
    const color =
      colorMap[riskLevel as keyof typeof colorMap] || 'bg-gray-100 text-gray-800 border-gray-200';
      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>
              Interactive map showing maternal health program metrics across India for{' '}
              {dateRangeText}
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm">
                  ...
                  <div className="mt-4 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Fetching GeoJSON data and initializing ECharts
                    </p>
                  </div>
                </div>
              )}
