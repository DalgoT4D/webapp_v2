...
export function DrillDownDialog({
  ...
  useEffect(() => {
    ...
    if (metric === 'mothers') {
      ...
      setDescription(
        region ? `Detailed metrics for ${region.name}` : 'Regional performance analysis'
      );
    }
    ...
    if (metric === 'mothers') {
      ...
      return {
        overview: [
          {
            month: 'Jan',
            visitRate: region.visitCompletion - 5,
            protocolRate: region.protocolAdherence - 4,
          },
          {
            month: 'Feb',
            visitRate: region.visitCompletion - 3,
            protocolRate: region.protocolAdherence - 2,
          },
          {
            month: 'Mar',
            visitRate: region.visitCompletion - 1,
            protocolRate: region.protocolAdherence - 1,
          },
          {
            month: 'Apr',
            visitRate: region.visitCompletion,
            protocolRate: region.protocolAdherence,
          },
          {
            month: 'May',
            visitRate: region.visitCompletion + 1,
