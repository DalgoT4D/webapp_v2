...
import { ChevronLeft, ChevronRight, ImageIcon, Link2, TriangleAlert, Trash2 } from 'lucide-react';
...
function BrandingPreview({ logoUrl }: { logoUrl: string | null }) {
  ...
  return (
    <div className="flex flex-col h-full rounded-lg  w-full">
      <div className="flex-1 bg-[#f1f5f9] p-3 pb-0 rounded-md  overflow-hidden flex flex-col">
        <div className="px-4 py-2  text-xs text-muted-foreground font-medium mb-4">
