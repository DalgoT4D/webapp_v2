      ...
      <CardContent className="p-3 space-y-2 overflow-auto max-h-[250px]">
        <div className="rounded-lg border p-2">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Strong correlation (r=0.78) between protocol adherence and risk reduction. 90%+
            adherence shows 65% faster improvement.
          </p>
        </div>
        ...
        <div className="rounded-lg border p-2">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Eastern district: 23% higher risk cases despite similar visit rates. Socioeconomic
        ...
        <div className="rounded-lg border p-2">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Nutritional protocols show 3.2x higher correlation to positive outcomes than other
            categories.
          </p>
        </div>
