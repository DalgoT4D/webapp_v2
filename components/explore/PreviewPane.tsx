  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-6 py-4 border-b">
        <h2 className="font-medium text-lg text-gray-900" data-testid="preview-table-name">
          {schema}.{table}
        </h2>
        <Button
          variant="ghost"
      ...
      {/* Pagination */}
      <div className="flex-shrink-0 flex items-center justify-between px-6 py-3 border-t border-gray-100 bg-gray-50/30">
