    ...
    <div className="space-y-3" data-testid="gsheets-auth-method">
      ...
      >
        <AuthOptionCard
          ...
          description="Pick your sheet in Google's own file picker. Dalgo gets access to that one file — nothing else in your Drive."
        ...
        <AuthOptionCard
          ...
          description="Share the sheet with your service account, then paste the key and the sheet link here."
