...
type IngestTab = 'connections' | 'sources' | 'warehouse';
...
interface ClassicIngestViewProps {
  mode: IngestUiMode;
  onModeChange: (mode: IngestUiMode) => void;
}

export function ClassicIngestView({ mode, onModeChange }: ClassicIngestViewProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0 border-b bg-background">
        <div className="flex items-start justify-between mb-6 p-6 pb-0">
          <div>
