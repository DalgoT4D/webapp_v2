...
function SortableChart({ id, chartOption, chartRef, onDownload, title }: SortableChartProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`bg-white rounded-lg border shadow-sm p-4 ${isDragging ? 'opacity-50 z-50' : ''}`}
      {...attributes}
    >
...
export default function Home() {
  ...
  const downloadDashboardAsPDF = async () => {
    try {
      ...
      pdf.setFontSize(12);
      pdf.text('Generated on: ' + new Date().toLocaleDateString(), pageWidth / 2, 30, {
        align: 'center',
      });
      ...
      pdf.text('Dalgo - Maternal Health Analytics Platform', pageWidth / 2, pageHeight - 10, {
        align: 'center',
      });
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">Welcome to Dalgo</h1>
        <p className="text-xl text-muted-foreground max-w-3xl">
          Your comprehensive maternal health program management platform. Monitor impact, track
          performance, and make data-driven decisions to improve healthcare outcomes.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <Button variant="default" size="sm" onClick={downloadDashboardAsPDF}>
